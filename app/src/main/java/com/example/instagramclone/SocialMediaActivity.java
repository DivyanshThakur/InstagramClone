                ...
                parseObject.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null) {
                            ...
                            Toasty.success(SocialMediaActivity.this,"Picture Uploaded", Toasty.LENGTH_SHORT,true).show();

                        } else {
                            Toasty.error(SocialMediaActivity.this,"Unknown Error: " + e.getMessage(), Toasty.LENGTH_LONG,true).show();
